...
import AdminStoreOwnerRequestsClient from "../../components/AdminStoreOwnerRequestsClient";
        ...
        <main className="min-h-screen text-gray-900 antialiased">
            ...
            <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
                <div className="mb-6">
                    ...
                    <h1 className="text-3xl font-black text-gray-950">Store owner requests</h1>
                    <p className="mt-2 text-sm text-gray-600">
                        Review and process store owner access requests.
                    </p>
                </div>
